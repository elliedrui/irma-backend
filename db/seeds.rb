...
Member.create(name: 'jumbler', email: 'jumbler@fussler.com', admin_level: 2, password: "password", uid: '')
Member.create(name: 'Alan', email: 'alan@alan.com', admin_level: 1, password: "password", uid: '')
Member.create(name: 'zed', email: 'zed@zed.com', admin_level: 2, password: "password", uid: '')
