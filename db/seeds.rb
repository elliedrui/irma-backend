...
Persona.create(first_name: 'Fred', last_name: 'Giguel', dob: "04-11-1975", sex: "male", race: "hispanic", member_id: 2, faction_id: 4)
Persona.create(first_name: 'Lawrence', last_name: 'Solten', dob: "01-07-1983", sex: "male", race: "caucasion", member_id: 3, faction_id: 2)
Persona.create(first_name: 'Binbial', last_name: 'Fres', dob: "07-27-1975", sex: "Female", race: "caucasion", member_id: 4, faction_id: 4)
Persona.create(first_name: 'Ero', last_name: 'Sres', dob: "02-01-1975", sex: "male", race: "hispanic", member_id: 5, faction_id: 1)
Persona.create(first_name: 'Lawrence', last_name: 'Solten', dob: "01-07-1983", sex: "male", race: "caucasion", member_id: 6, faction_id: 2)
# create guns
